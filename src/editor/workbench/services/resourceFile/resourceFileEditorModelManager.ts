...
export class ResourceFileEditorModelManager {
    ...
    private mapResourceToPendingModelLoaders: Map<
        String,
    ...
    constructor(
        ...
        this.mapResourceToPendingModelLoaders = new Map<
            String,
            Promise<ResourceFileEditorModel>
        >();
    }
    ...
    public loadOrCreate(
        ...
        if (model) {
            ...
            model = this.instantiationService.create(
                ResourceFileEditorModel,
                resource
            );
            modelLoadPromise = model.load();
