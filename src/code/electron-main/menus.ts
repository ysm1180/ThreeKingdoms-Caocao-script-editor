...
export class AppMenu {
    ...
    constructor(
        ...
        this.keybindingsResolver = instantiationService.create(
            KeybindingsResolver
        );
    ...
    private install() {
        ...
        arrays
            .coalesce([fileMenuItem, optionMenuItem, toolMenuItem])
    ...
    private setOptionMenuItem(editMenu: Menu) {
        ...
        arrays
            .coalesce([maxCompressPngOption, defaultPngOption])
        ...
        arrays
            .coalesce([me5SaveOption, pngSaveOption])
