...
export const IInstantiationService = decorator<InstantiationService>(
...
export class InstantiationService implements IInstantiationService {
    ...
    public invokeFunction<R>(
        fn: (accessor: ServicesAccessor) => R,
        ...args: any[]
    ) {
