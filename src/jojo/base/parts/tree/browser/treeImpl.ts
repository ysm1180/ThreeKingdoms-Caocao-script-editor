...
import { IDataController, IDataRenderer, IDataSource, ITree, ITreeConfiguration, ITreeOptions } from 'jojo/base/parts/tree/browser/tree';
import { IFocusEvent, TreeModel } from 'jojo/base/parts/tree/browser/treeModel';
import { TreeView } from 'jojo/base/parts/tree/browser/treeView';
...
export class Tree implements ITree {
  ...
  public refresh(element: any, skipRenderChildren = false): Promise<any> {
