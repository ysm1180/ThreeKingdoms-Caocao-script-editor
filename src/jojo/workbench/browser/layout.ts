import { DomBuilder, Size } from 'jojo/base/browser/domBuilder';
import { ISashLayoutProvider, Sash } from 'jojo/base/browser/ui/sash';
import { Disposable, IDisposable } from 'jojo/base/common/lifecycle';
...
import { TitlePart } from 'jojo/workbench/browser/parts/titlebar/titlePart';
...
export class WorkbenchLayout extends Disposable implements ISashLayoutProvider {
  ...
  public layout() {
    ...
    this.workbench.position(0, 0, 0, 0, 'relative').size(this.workbenchSize.width, this.workbenchSize.height);
