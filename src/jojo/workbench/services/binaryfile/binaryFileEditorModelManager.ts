...
import { IBinaryFileEditorModelManager } from 'jojo/workbench/services/binaryfile/binaryFiles';

export class BinaryFileEditorModelManager implements IBinaryFileEditorModelManager {
