...
import { IEditorInput, IResourceInput, IUntitleResourceInput } from 'jojo/platform/editor/common/editor';
...
export class WorkbenchEditorService {
  ...
  constructor(editorPart: EditorPart, @IInstantiationService private instantiationService: IInstantiationService) {
